...
export function YouTubeSummarizer({
  ...
  return (
    <section className="border-b border-slate-200 bg-red-50 px-3 py-2">
      <p className="text-xs font-medium text-red-800">▶ YouTube video detected</p>
      <p className="mt-0.5 line-clamp-1 text-[11px] text-red-700">{context.title}</p>
      ...
      {context.hasTranscript ? (
        ...
        <p className="mt-1 text-[11px] text-red-700">No captions available for this video.</p>
      )}
